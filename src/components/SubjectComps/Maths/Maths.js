...
const Maths = () => {
    const subSubjectData = [
        {name: 'Mathematics', levels: ['KS2', 'KS3', 'KS4', 'GCSE'], ages:['11+', '13+'], exam_boards: ['AQA', 'WJEC', 'International']},
        {name: 'Maths Numeracy', levels: ['KS4', 'GCSE'], ages:['11+', '13+'], exam_boards: ['AQA', 'WJEC', 'International']},
    ]
